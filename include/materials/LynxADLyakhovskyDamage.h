...
//   virtual void updateElasticModuli(ADReal & K, ADReal & G, const ADRankTwoTensor & elastic_strain) override;

// protected:
//   virtual ADRankFourTensor damageStiffness(const ADRankFourTensor & Cijkl);
...
//   virtual ADReal computeDamagePoroMech(const ADReal & gamma_s, const ADReal & gamma_d, const ADRankTwoTensor & elastic_strain_incr);
