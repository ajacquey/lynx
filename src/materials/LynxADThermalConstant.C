...
#include "LynxADThermalConstant.h"

registerMooseObject("LynxApp", LynxADThermalConstant);

InputParameters
LynxADThermalConstant::validParams()
{
  InputParameters params = LynxADThermalBase::validParams();
...
LynxADThermalConstant::LynxADThermalConstant(const InputParameters & parameters)
  : LynxADThermalBase(parameters),
...
void
LynxADThermalConstant::computeQpHeatCap()
{
...
void
LynxADThermalConstant::computeQpThermalCond()
{
...
void
LynxADThermalConstant::computeQpThermalExp()
{
